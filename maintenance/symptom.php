...
if (isset($_POST['add_symptom'])) {
    ...
    mysqli_query($db_connection, "INSERT INTO tblsymptom (symptom, is_archived) VALUES ('$symptom', 'No')");
...
if (isset($_POST['edit_symptom']) && isset($_POST['symptom_id'])) {
    ...
    mysqli_query($db_connection, "UPDATE tblsymptom SET symptom = '$symptom' WHERE symptom_id = $symptom_id");
...
if (isset($_GET['symptom_id'])) {
    ...
    $result = mysqli_query($db_connection, "SELECT symptom FROM tblsymptom WHERE symptom_id = $symptom_id");
